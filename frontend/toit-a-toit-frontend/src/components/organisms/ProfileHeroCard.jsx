const defaultAvatarByRole = {
  OWNER: '/profil/owner.png',
  SEEKER: '/profil/seeker.png',
  ASSOCIATION: '/profil/asso.png',
};

const ProfileHeroCard = ({ user, locationLabel, role, onEdit, onShare }) => {
  ...
  const avatarUrl = defaultAvatarByRole[role];
